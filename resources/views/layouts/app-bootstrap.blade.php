...
<head>
    ...
    <style>
        ...
        .nav-link.active .trashcan-count { background: rgba(255,255,255,0.25); }
        .brand-logo { font-size: 1.5rem; font-weight: 700; }
        ...
        .btn-restore:hover { background: #059669; border-color: #059669; }
...
<script>
    ...
    function getPreferredTheme() {
        ...
        // toggle mode - check localStorage
        return localStorage.getItem('trashcan-theme') || 'light';
    }

    function setTheme(theme) {
        document.documentElement.setAttribute('data-bs-theme', theme);
        localStorage.setItem('trashcan-theme', theme);
    ...
    // Checkbox and bulk action handling
    ...
    function updateBulkButtons() {
        ...
        document.querySelectorAll('.bulk-btn').forEach(btn => btn.disabled = checked === 0);
